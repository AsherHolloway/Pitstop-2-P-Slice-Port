...
function createWinIcons()
	if not lowQuality then
		...
		if bfWinningIcons == true then
			makeLuaSprite('winIcoPlayer', 'icons/win-icons/win-'..getProperty('boyfriend.healthIcon'), getProperty('iconP1.x'), getProperty('iconP1.y'))
		...
		if dadWinningIcons == true then
			makeLuaSprite('winIcoOpponent', 'icons/win-icons/win-'..getProperty('dad.healthIcon'), getProperty('iconP2.x'), getProperty('iconP2.y'))
